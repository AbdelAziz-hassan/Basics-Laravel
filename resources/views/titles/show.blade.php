...
@section('content')
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            ...
            <div class="row">
                <div class="col-lg-6">
                <img src="/{{$title->picture}}" width="400" height="500">
                </div>
                <div class="col-lg-6">
                    <div class="col-sm-6">
        ...
        <div class="tab-pane fade" id="seasons" role="tabpanel" aria-labelledby="seasons-tab">
            ...
            @endif
            <div class="">
                @include('seasons.table',['seasons'=>$seasons])
            </div>
        </div>
        <div class="tab-pane fade" id="cast" role="tabpanel" aria-labelledby="cast-tab">
            <h4 class="b-under"> @lang('titles.cast_info')</h4>
            <h1 class="pull-right">
                <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('casts.create',['title_id'=>$title->id]) !!}">@lang('app.add_new')</a>
            </h1>
            <div class="">
                @include('casts.table',['casts'=>$casts])
            </div>
        </div>
